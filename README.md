  ...
  ...
    ...
    (currentTimeHtml =
      hnum < 18 && hnum >= 9
        ...
        : `<img class='boardsign' src='https://lskypro.acozycotage.net/Fomalhaut/badge/小破站-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">小破站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
